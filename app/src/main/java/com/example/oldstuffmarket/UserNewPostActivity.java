...
import com.example.oldstuffmarket.ui.notifications.NewPostViewModel;
...
public class UserNewPostActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.user_new_post_layout);
        ...
        ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(UserNewPostActivity.this, android.R.layout.simple_spinner_item, danhMucList);
