...
public class UserShopEditActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.user_shop_edit_layout);
                    ...
                    if(snapshot.getValue(ShopData.class).getShopID().equals(shopID)){
                        ...
                        storageReference.child(snapshot.getValue(ShopData.class).getShopImage() + ".png").getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                            ...
                            public void onSuccess(Uri uri) {
                                Glide.with(UserShopEditActivity.this).load(uri).into(imgShop);
                            }
...
//                Toast.makeText(context, "Hinh anh khong ton tai!", Toast.LENGTH_SHORT).show();
                        ...
                        edtTenShop.setText(snapshot.getValue(ShopData.class).getShopName());
                        edtMoTaShop.setText(snapshot.getValue(ShopData.class).getMoTaShop());
                    }
                            ...
                            case DialogInterface.BUTTON_POSITIVE:
                                ...
                                databaseReference.child("Shop").addChildEventListener(new ChildEventListener() {
                                    ...
                                    public void onChildAdded(@NonNull DataSnapshot snapshot, @Nullable String previousChildName) {
                                        ...
                                        if(snapshot.getValue(ShopData.class).getShopID().equals(shopID)){
                                            storageReference.child(snapshot.getValue(ShopData.class).getShopImage() + ".png").delete().addOnSuccessListener(new OnSuccessListener<Void>() {
                                                @Override
...
//                                                    Toast.makeText(AccountInfoActivity.this, "Xoa hinh that bai", Toast.LENGTH_SHORT).show();
                                            ...
                                            ShopData shopData = new ShopData(shopID, snapshot.getValue(ShopData.class).getUserID(), edtTenShop.getText().toString(), edtMoTaShop.getText().toString(), shopImage, dateFormat.format(date),snapshot.getValue(ShopData.class).getTinhTrangShop());
