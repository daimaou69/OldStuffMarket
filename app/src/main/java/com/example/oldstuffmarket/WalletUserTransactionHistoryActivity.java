...
public class WalletUserTransactionHistoryActivity extends AppCompatActivity {
    ...
    public void userDepositRequestLoad(){
        YeuCauChuyenKhoanAdapter yeuCauChuyenKhoanAdapter = new YeuCauChuyenKhoanAdapter(WalletUserTransactionHistoryActivity.this,R.layout.yeu_cau_chuyen_khoan_adapter_layout, userDepositDataArrayList);
