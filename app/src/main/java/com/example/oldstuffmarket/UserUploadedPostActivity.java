...
public class UserUploadedPostActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.user_uploaded_post_layout);
    ...
    public void userSanPhamLoad(){
        SanPhamAdapter sanPhamAdapter = new SanPhamAdapter(UserUploadedPostActivity.this, R.layout.san_pham_adapter_layout, sanPhamArrayList);
