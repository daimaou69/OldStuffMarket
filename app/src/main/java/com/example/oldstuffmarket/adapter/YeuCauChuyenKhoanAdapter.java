    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        databaseReference.child("User").addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(@NonNull DataSnapshot snapshot, @Nullable String previousChildName) {
                if(snapshot.getValue(UserData.class).getsUserID().equals(userDepositData.getUserID())){
...
//                            Toast.makeText(context, "Hinh anh khong ton tai!", Toast.LENGTH_SHORT).show();
                    ...
                    viewHolder.txtUserName.setText("User: " + snapshot.getValue(UserData.class).getsUserName() + "-" + snapshot.getValue(UserData.class).getsFullName() +
