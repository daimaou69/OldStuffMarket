...
import com.example.oldstuffmarket.adapter.UserAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
                ...
                if(!s.toString().isEmpty()){
                    ...
                    databaseReference.child("User").addChildEventListener(new ChildEventListener() {
                        ...
                        public void onChildAdded(@NonNull DataSnapshot snapshot, @Nullable String previousChildName) {
                            if(snapshot.getValue(UserData.class).getiPermission() == 1 && !snapshot.getValue(UserData.class).getsUserID().equals(userID)){
        ...
        gridUser.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        switch (which){
                            case DialogInterface.BUTTON_POSITIVE:
                                ...
                                intent.putExtra("NguoiCanGapID", userDataArrayList.get(position).getsUserID());
                                intent.putExtra("NguoiCanGapName", userDataArrayList.get(position).getsFullName());
                ...
                builder.setMessage("Chọn user " + userDataArrayList.get(position).getsFullName() + "?").setNegativeButton("No",dialogClick).setPositiveButton("Yes",dialogClick).show();
            }
        });
    }
